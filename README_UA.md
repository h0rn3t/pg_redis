...
Простір ключів живе в спільній пам'яті PostgreSQL (`ShmemInitHash` з
`HASH_PARTITION`) і видимий кожному бекенду. Змінно-розмірні навантаження
...
`pg_redis.lock_partitions` секційними `LWLock`.
